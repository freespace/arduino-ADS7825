...
PRJSRC=main.c uart.c ads7825.c digital_out.c trigger.c
...
# If using the arduino bootloader, you need to specify a baudrate. It depends
# on the board being programmed, best way to find out is to consult the
# bootloader source, or this file:
# http://code.google.com/p/arduino/source/browse/trunk/hardware/arduino/boards.txt
AVRDUDE_BAUD=57600
